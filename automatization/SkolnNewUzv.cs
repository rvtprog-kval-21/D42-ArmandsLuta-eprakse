...
namespace SkolnCreate.Tests{
    [TestFixture]
    public class SkolPraksVadNewuzv{
        ...
        public void TestDer(){
            ...
            SkolnPage.getUzvards().SendKeys("Kristaps");
        ...
        public void TestCipari(){
            ...
            System.Threading.Thread.Sleep(2000);
            _driver.SwitchTo().Frame(SkolnPage.getNewIframe());
            SkolnPage.getUzvards().SendKeys("54354");
            SkolnPage.getNewSave().Click();
        ...
        public void TestKrievs(){
            ...
            System.Threading.Thread.Sleep(2000);
            _driver.SwitchTo().Frame(SkolnPage.getNewIframe());
            SkolnPage.getUzvards().SendKeys("вфыв");
            SkolnPage.getNewSave().Click();
            IList <IWebElement> errors = SkolnPage.getNewErrors();
            foreach(IWebElement e in errors) {
                if(e.Text == "Uzvārdam jābūt uzrakstītam ar latīņu alfabētu."){
