...
namespace macDalaJaunsUzvards.Tests
{
    [TestFixture]
    public class macDalaJaunsUzvardsTests{
        ...
        public void TestDer(){
            ...
            macDalaNewLiet.clickNewLiet();
            System.Threading.Thread.Sleep(1000);
            macDalaNewLiet.inputUzvards("Kristaps");
            macDalaNewLiet.clickSaveNew();
            IList <IWebElement> errors = macDalaNewLiet.getErrors();
            foreach(IWebElement e in errors) {
                if(e.Text == "Uzvārdam jābūt uzrakstītam ar latīņu alfabētu."){
        ...
        public void testnedercipari(){
            ...
            macDalaNewLiet.clickNewLiet();
            System.Threading.Thread.Sleep(1000);
            macDalaNewLiet.inputUzvards("31251356");
            macDalaNewLiet.clickSaveNew();
            IList <IWebElement> errors = macDalaNewLiet.getErrors();
            foreach(IWebElement e in errors) {
                if(e.Text == "Uzvārdam jābūt uzrakstītam ar latīņu alfabētu."){
