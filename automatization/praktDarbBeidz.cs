...
namespace praktIkdDarbBeidz.Tests{
    [TestFixture]
    public class praktIkdDarbBeidzTests{
        ...
        public void TestDer(){
            ...
            dienIer.inputDarbuBeidzu("12:20");
            dienIer.clickSave();
            IList <IWebElement> errors = dienIer.getErrors();
            foreach(IWebElement e in errors) {
                if(e.Text == "Laikam jābūt ievadītām pareizi, piem: \"13:20\""){
        ...
        public void testnedersimboli(){
            ...
            dienIer.inputDarbuBeidzu("323:3211");
            dienIer.clickSave();
            IList <IWebElement> errors = dienIer.getErrors();
            foreach(IWebElement e in errors) {
                if(e.Text == "Laikam jābūt ievadītām pareizi, piem: \"13:20\""){
        ...
        public void testnederAlfabets(){
            ...
            dienIer.inputDarbuBeidzu("asdasdasd");
            dienIer.clickSave();
            IList <IWebElement> errors = dienIer.getErrors();
            foreach(IWebElement e in errors) {
                if(e.Text == "Laikam jābūt ievadītām pareizi, piem: \"13:20\""){
